...
> روحي مباشرة لمجلد [`docs/`](./docs/) — فيه دليل استخدام كامل لكل لعبة على حدة ([`docs/quiz.md`](./docs/quiz.md)، [`docs/true-false.md`](./docs/true-false.md)، [`docs/riddles.md`](./docs/riddles.md)، [`docs/eye.md`](./docs/eye.md)، و[`docs/emoji.md`](./docs/emoji.md))، فيه بس الـ endpoints وأمثلة Baileys الجاهزة للنسخ، من غير أي تفاصيل معمارية داخلية. هذا الملف (`README.md`) للمطوّرين اللي بيشتغلوا على المشروع نفسه.
>
